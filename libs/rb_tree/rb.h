...
struct rb_traverser
  {
    const struct rb_table *rb_table;        /* Tree being traversed. */
...
void rb_t_init (struct rb_traverser *, const struct rb_table *);
void *rb_t_first (struct rb_traverser *, const struct rb_table *);
void *rb_t_last (struct rb_traverser *, const struct rb_table *);
void *rb_t_find (struct rb_traverser *, const struct rb_table *, void *);
